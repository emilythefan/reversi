...
socket.on('join_room_response',function(payload) {
	...
	/* If we have sent the person who just joined (something weird happened) */
	else {
...
socket.on('game_update',function(payload) {
	...
	else if(socket.id == payload.game.player_orange.socket) {
		my_color = 'orange';
	}
	else{
		...
		for(column = 0; column < 8; column++) {
			...
			if(old_board[row][column] != board[row][column]) {
				if(old_board[row][column] == '?' && board[row][column] == ' ') {
					...
					$('#'+row+'_'+column).html('<img src="assets/images/empty_to_orange.gif" alt="orange square"/>');
				}
					...
					$('#'+row+'_'+column).html('<img src="assets/images/orange_to_empty.gif" alt="empty square"/>');
				}

				else if(old_board[row][column] == 'b' && board[row][column] == 'o') {
					$('#'+row+'_'+column).html('<img src="assets/images/blue_to_orange.gif" alt="orange square"/>');
				}

				else if(old_board[row][column] == 'o' && board[row][column] == 'b') {
					$('#'+row+'_'+column).html('<img src="assets/images/orange_to_blue.gif" alt="blue square"/>');
				}
